...
public class UserAccountBuyWithPointsSceneBuilder {

	private MainSceneBuilder mainSceneBuilder;

	public Scene createScene(Stage primaryWindow, String firstName, String lastName, String userName, Double pointsLeft,
			Double hasToPay) {
		...
		Label hasToPayLabel = new Label("Has to pay: ");
		hasToPayLabel.setMinSize(270, 60);
		...
		mainLayout.add(hasToPayLabel, 0, 4);
		...
		Label pointslabel = new Label(String.valueOf(pointsLeft));
		pointslabel.setMinSize(270, 60);

		Label hastopaylabel = new Label(String.valueOf(hasToPay));
		hastopaylabel.setMinSize(270, 60);
		...
		mainLayout.add(hastopaylabel, 1, 4);
